...
{
       0,   239,   239,   243,   247,   252,   255,   261,   267,   273,
     281,   285,   293,   299,   307,   313,   321,   329,   332,   338,
     344,   352,   405,   408,   414,   420,   426,   432,   435,   440,
     443,   446,   449,   468,   471,   474
};
#endif
...
static const char *const yytname[] =
{
  ...
  "power_exp", "basic_exp", "number", "timestamp", YY_NULLPTR
};
#endif
...
#line 449 "parser.y" /* yacc.c:1646  */
    {
		    ...
		    if (strcasecmp((yyvsp[0].id), "UTC") != 0 &&
			    strcasecmp((yyvsp[0].id), "GMT") != 0 &&
			    strcasecmp((yyvsp[0].id), "Z") != 0) {
			ut_set_status(UT_UNKNOWN);
			error = 1;
		    }
		    ...
		    if (!error) {
			(yyval.rval) = (yyvsp[-2].rval) + (yyvsp[-1].rval);
		    }
		    else {
			YYERROR;
		    }
